...
public class SI_LevelSelectHandler : MonoBehaviour
{
    [Header("Configs")]
    ...
    private void Update()
    {
        ...
        label_LVL1_Highscore.SetText($"{playerData.profile_SI_Level_1_Score}");
        label_LVL2_Highscore.SetText($"{playerData.profile_SI_Level_2_Score}");
        label_LVL3_Highscore.SetText($"{playerData.profile_SI_Level_3_Score}");

        if (playerData.stage_SI_1_cleared)
